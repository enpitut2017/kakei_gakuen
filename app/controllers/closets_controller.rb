class ClosetsController < ApplicationController
    ...
    def edit
		...
		#userが現在設定している装備を取得
		user_clothes_data = Clothe.where(id:[@user_clothes.upper_colthes, @user_clothes.lower_colthes, @user_clothes.sox, @user_clothes.front_hair, @user_clothes.back_hair, @user_clothes.face])
